              ...
              <div class="ecommerce-widget bg-white p-5">
                <div class="row mb-4">
                  ...
                  <div class="col-lg-6 text-right">
                    <a href="../../public/relatorio.php?id=mesas" target="_blank" class="btn btn-sm btn-info">Imprimir relatório</a>
                  </div>
                              ...
                              ?>
                                <tr>
                                  ...
                                  <td class="text-center">
                                    <a href="editar-mesas.php?id=mesas&idUser=<?= $details['id_mesa'] ?>&id=<?= $details['id_mesa'] ?>&action=delete" class="btn btn-danger btn-sm">
